...
["dart.async", "dart:async", , P, {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 50, 18, 19],
...
["", "test_webview.dart", , K, {
  ...
  main: [function() {
    var t1, webview_el;
    t1 = J.get$onClick$x(document.querySelector("#button1"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(K.sendMessage$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    webview_el = document.querySelector("webview");
    t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_message._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(K.onMessage$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = P.JsObject_JsObject$fromBrowserObject(webview_el);
    $._webview = t1;
    t1.callMethod$2("addEventListener", ["exit", K._dispatch$closure()]);
    $._webview.callMethod$2("addEventListener", ["loadabort", K._dispatch$closure()]);
    $._webview.callMethod$2("addEventListener", ["loadcommit", K._dispatch$closure()]);
    $._webview.callMethod$2("addEventListener", ["loadredirect", K._dispatch$closure()]);
    $._webview.callMethod$2("addEventListener", ["loadstart", K._dispatch$closure()]);
    $._webview.callMethod$2("addEventListener", ["loadstop", K._dispatch$closure()]);
  }, "call$0", "main$closure", 0, 0, 13],
  _dispatch: [function(e) {
    var t1;
    e = P.JsObject_JsObject$fromBrowserObject(e);
    t1 = J.getInterceptor$asx(e);
  ...
  onMessage: [function(e) {
    ...
    P.print(t1.toString$0(e));
    if (t1.get$data(e) == null || J.$eq(t1.get$data(e), ""))
      return;
    P.print(t1.get$data(e));
  }, "call$1", "onMessage$closure", 2, 0, 34, 1]
},
1],
]);
...
//# sourceMappingURL=test_webview.dart.js.map
//@ sourceMappingURL=test_webview.dart.js.map
